...
export const pageConstants = {
  PAGE_REGISTER_REQUEST: "PAGE_REGISTER_REQUEST",
  PAGE_REGISTER_FAILURE: "PAGE_REGISTER_FAILURE",
  PAGE_REGISTER_SUCCESS: "PAGE_REGISTER_SUCCESS",
};
...
export const productConstants = {
  ...
  PRODUCT_PAGE_REQUEST: "PRODUCT_PAGE_REQUEST",
  PRODUCT_PAGE_SUCCESS: "PRODUCT_PAGE_SUCCESS",
  PRODUCT_PAGE_FAILURE: "PRODUCT_PAGE_FAILURE",
};
